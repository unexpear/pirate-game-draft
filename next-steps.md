...
- [ ] Wind + visible sail (Black Flag style) — wind direction affects speed (fast downwind, slow upwind) with an indicator; a rendered mast + sail that trims to the wind.
