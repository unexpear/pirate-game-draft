...
- [ ] Boarding — the Black Flag crown jewel: cripple an enemy (low but not sunk) → pull alongside at low speed → board to **capture** it (crew/loot) instead of just sinking it. Melee-on-deck can be abstracted at first.
