...
- [ ] Build mode next — the rest of the taxonomy (garboard, wales, floors, futtocks, keelson, deck beams, knees, mast step) and **clinker-vs-carvel** plank visuals (overlapping riveted strakes vs flush treenailed planking); interactive click-to-place with per-tradition validation; then buoyancy/stats update live as you build.
