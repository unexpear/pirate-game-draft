...
- **Deliberate deviation (we go beyond Black Flag here):** BF is essentially wind-neutral arcade handling. We model **real points of sail** instead — a no-go zone you must tack out of, fastest on a reach, slower dead downwind, plus leeward **heel** and sails that **trim/luff**. This is a conscious "more realistic than BF" choice for feel and look, layered under BF's arcade *control scheme*. See [../holes.md](../holes.md).
